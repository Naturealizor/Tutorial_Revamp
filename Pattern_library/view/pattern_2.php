...
<meta name="description" content="CSS Selectors Cheatsheet: Using contextual selectors, attribute selectors, pseudo-element selectors, and pseudo-class selectors to apply formatting to HTML elements.">
...
<!-- <div id="container"> -->
  ...
  <div id="main">
<p><a href="/index.php">Home</a> &gt; <a href="/support/index.php">Tutorials and Resources</a> &gt; CSS Selectors Cheat Sheet</p>
<article>
<header> -->
  <h2>CSS Selectors Cheat Sheet</h2>
  <p>By B Lingafelter&nbsp;&nbsp;&nbsp;<i class="fa fa-calendar"></i>&nbsp;
        <time datetime="2013-04-21">Apr 21, 2013</time>
        &nbsp;&nbsp;&nbsp;
